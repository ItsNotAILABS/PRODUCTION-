...
const EXTENSIONS = [
  ...
  // ── Alpha Tools (production tools, adapters, plugins) ─────────────────────
  { id: 'EXT-041', slug: 'alpha-tools-hub', name: 'Alpha Tools Hub', engines: ['AlphaTransformer', 'AlphaAnalyzer', 'AlphaGenerator', 'AlphaConnector', 'AlphaAutomator'], ring: 'Sovereign Ring', wire: 'intelligence-wire/alpha-tools', userExperience: 'Production Alpha Tools — 5 tool categories (Transform, Analyze, Generate, Connect, Automate), 5 built-in plugins (JSON Flattener, Markdown Generator, Data Validator, Phi Encoder, Batch Processor), 5 built-in adapters (REST API, GraphQL, WebSocket, Event Bus, Organism Mesh). User-facing tool dashboard with phi-enhanced orchestration and PROTO-244 protocol.' }
];
